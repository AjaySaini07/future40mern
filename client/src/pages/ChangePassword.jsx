...
export default function ChangePassword() {
  ...
  return (
    <div
      ...
      bg-gradient-to-br from-slate-900 to-slate-950 rounded-sm px-4"
    >
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full max-w-sm sm:max-w-md
        bg-slate-900 border border-slate-800
        rounded-md p-4 sm:p-6 space-y-1 sm:space-y-3 shadow-2xl"
      >
        {/* Header */}
        <div className="text-center space-y-1">
          <h2 className="text-xl sm:text-2xl font-bold text-white drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]">
            Change Password
          </h2>
